...
var n=p._oElements[o],t={},c=n.getAttribute("voice_encode_fileid")||"";
try{
c=decodeURIComponent(c);
}catch(d){}
t.voiceid=m.encodeStr(c),t.voiceid=t.voiceid.replace(/&#61;/g,"=").replace(/^\s/,"").replace(/\s$/,""),
t.isaac=1*n.getAttribute("isaac2")||0,t.src=p.srcRoot.replace("#meidaid#",t.voiceid),
...
d&&d.parentNode.removeChild(d),t(i),p.musicList[i.voiceid+"_"+i.posIndex]=i;
}
function t(e){
...
define("appmsg/async.js",["biz_wap/ui/weui.js","biz_common/utils/string/html.js","appmsg/reward_utils.js","appmsg/pay_read_utils.js","appmsg/pay_report_utils.js","pages/create_txv.js","pages/video_ctrl.js","biz_common/utils/url/parse.js","appmsg/img_copyright_tpl.html.js","appmsg/appmsgext.js","appmsg/share_tpl.html.js","biz_common/dom/event.js","biz_wap/utils/ajax.js","biz_wap/jsapi/core.js","biz_common/tmpl.js","complain/localstorage.js","appmsg/log.js","rt/appmsg/getappmsgext.rt.js","a/a_utils.js","appmsg/related_article.js","appmsg/like_profile.js","appmsg/set_font_size.js","biz_wap/utils/device.js","biz_wap/utils/mmversion.js","pages/version4video.js","appmsg/read.js","appmsg/like.js","appmsg/like_and_share.js","appmsg/set_article_read.js","appmsg/comment.js","appmsg/iframe.js","redpackage/redpacketcover.js","appmsg/more_read.js","appmsg/album_keep_read.js"],function(e){
"use strict";
function t(){
for(var t=document.getElementsByTagName("iframe"),a=[],r=0,o=t.length;o>r;++r)a.push(t[r]);
t=null;
var s=document.getElementById("js_content"),n=s.offsetWidth,_=n/l.getRatio();
...
if(!c.isShowMpVideo()){
var w;
w=i(u?d:d),w&&x.push(w),"function"==typeof window.__addIdKeyReport&&(window.__addIdKeyReport("28307",10),
...
function i(e){
var t=e.getAttribute("data-src")||e.getAttribute("src"),i=m.getQuery("vid",t),r=e.getAttribute("data-vw"),o=e.getAttribute("data-vh"),s=e.getAttribute("data-ratio"),n=document.createElement("span");
n.setAttribute("data-ratio",s),n.id="js_tx_video_container_"+Math.random(),n.className="js_tx_video_container",
...
allowFullScreen:!0,
onSuccess:function(e){
n.playerObj=e.player,a(n,i),n.style.display="block";
},
onError:function(){}
...
var s=i.children[r];
s.className.indexOf("img_loading")>=0&&s.getAttribute("data-vid")==t&&a.push(s);
}
...
for(var t={},i=e.img_copy_info.list,a=window.__appmsgCgiData.copyright_stat,r=window.__appmsgCgiData.source_biz,o=0,s=i.length;s>o;o++){
var n=i[o];
if(2==n.type){
...
for(var _=document.getElementsByTagName("img"),o=0,s=_.length;s>o;o++){
var n=_[o],d=n.getAttribute("data-src")||n.getAttribute("data-backsrc")||"";
if(t[d]){
var p=document.createElement("div");
p.innerHTML=y.tmpl(c,t[d],!1);
{
var l=p.children[0],m=n.parentNode,w=m.insertBefore(l,n),g=w.children[0];
(function(e,t){
...
i.show_read){
var o=document.getElementById("js_read_area3"),s=document.getElementById("readNum3");
if(!o||!s)return;
...
var x=e("appmsg/comment.js");
x.initComment(t);
}
b.setBackgroundClass(),n.init(_extends({
isFans:t.is_fans
},t.reward),{
...
var S=document.getElementById("js_cmt_container");
if(1==t.comment_entrance_enable_for_preview&&window.is_temp_url&&S&&(S.style.display="block"),
...
})),t.comment_enabled&&S&&(S.style.display="block"),I.isIOS&&"block"===S.style.display&&location.href.match(/fontScale=\d+/)&&z.isIPadOS13){
var E=location.href.match(/fontScale=(\d+)/);
z.setFontSize(S,parseFloat(E[1])/100);
}
var A=[],B="",R=a.old_liked_before,P=a.seen_before,N=a.favorite_before,O=a.share_before,W=a.reward_before,C=a.pay_before,D=i.old_liked,q=i.liked;
(D||R)&&(B="praise",A.push("like")),(q||P)&&(B="like",A.push("zaikan")),N&&(B="favorite",
A.push("collect")),O&&(B="share",A.push("share")),W&&A.push("reward"),C&&A.push("pay"),
j&&A.length>0&&j.renderLikeProfile(A),k&&(i.old_liked||a.old_liked_before?k.render("praise",!0):i.liked||a.seen_before?k.render("like",!0):a.favorite_before?k.render("favorite",!0):a.share_before?k.render("share",!0):k.isFromRecommend||!window.is_login?k.render("other",!0):a.reward_before?k.render("reward",!0):a.pay_before&&k.render("pay",!0));
}
function s(){
...
var s=e("redpackage/redpacketcover.js");
s.render({
list:t.red_packet_cover_data.cover_uri_data
});
}
var n=document.getElementById("js_more_read_area");
if(n&&t&&t.more_read_list&&t.more_read_list.length&&e("appmsg/more_read.js")(n,t.more_read_list),
...
var l=new Image;
return l.src=("http://mp.weixin.qq.com/mp/jsreport?1=1&key=1&content=biz:"+biz+",mid:"+mid+",uin:"+uin+"[key1]"+encodeURIComponent(p.toString())+"&r="+Math.random()).substr(0,1024),
console&&console.error(p),void("undefined"!=typeof window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs&&WX_BJ_REPORT.BadJs.onError(p));
}
},
onError:function(){
var e=new Image;
...
var n=e("appmsg/reward_utils.js"),_=e("appmsg/pay_read_utils.js"),d=e("appmsg/pay_report_utils.js"),p=e("pages/create_txv.js"),l=e("pages/video_ctrl.js"),m=e("biz_common/utils/url/parse.js"),c=e("appmsg/img_copyright_tpl.html.js"),w=e("appmsg/appmsgext.js"),g=(e("appmsg/share_tpl.html.js"),
...
e("appmsg/log.js")),b=(e("rt/appmsg/getappmsgext.rt.js"),e("a/a_utils.js")),k=e("appmsg/related_article.js"),j=e("appmsg/like_profile.js"),x=[],z=e("appmsg/set_font_size.js"),I=(e("biz_wap/utils/device.js"),
...
g=60),i.isAccessibility&&(f=g=1e5),!t.show&&(s.top<=0&&s.top+s.height+f>=0||s.top>0&&s.top<e+g)&&(i.inImgRead&&(s.top<=0&&s.top+s.height>=0||s.top>0&&s.top<e)&&i.inImgRead(r,networkType),
...
});define("appmsg/share.js",["biz_common/utils/string/html.js","appmsg/cdn_img_lib.js","biz_common/jquery.md5.js","biz_common/utils/url/parse.js","biz_wap/utils/mmversion.js","appmsg/appmsg_report.js","appmsg/malicious_wording.js","biz_wap/utils/jsmonitor_report.js","appmsg/related_article.js","appmsg/share_biz.js","biz_wap/jsapi/core.js"],function(e){
"use strict";
function i(e,i,n){
var t="",s="";
try{
...
var r=[a,"mpshare=1","scene="+i,"srcid="+srcid,"sharer_sharetime="+n,"sharer_shareid="+u];
if(""!=s&&r.push(s),a=r.join("&"),2===i&&_&&_.indexOf(p)>-1){
var o=Math.floor(Math.random()*h.length),l=h[o];
t=e.split("?")[0]+"?"+a+("&testtype="+l)+"#"+(e.split("#")[1]||"");
}else t=e.split("?")[0]+"?"+a+"#"+(e.split("#")[1]||"");
}
}catch(c){
t="";
}
...
var s=e("biz_common/utils/url/parse.js"),a=e("biz_wap/utils/mmversion.js"),r=e("appmsg/appmsg_report.js"),o=e("appmsg/malicious_wording.js"),m=e("biz_wap/utils/jsmonitor_report.js"),l=e("appmsg/related_article.js"),c=e("appmsg/share_biz.js"),_=c.shareBizTest,u=window.md5(window.user_uin),h=["testrd","otherrd"],p=0;
try{
p=1*window.atob(window.biz);
}catch(d){}
var g=e("biz_wap/jsapi/core.js");
g.call("hideToolbar"),g.call("showOptionMenu");
var f=msg_title.htmlDecode(),w=(msg_source_url.htmlDecode(),""),b=cdn_url_1_1||msg_cdn_url||ori_head_img_url||round_head_img,k=b,v=msg_link.htmlDecode(),f=msg_title.htmlDecode(),j=msg_desc.htmlDecode();
j=j||"",j=j.replace(/<br\/>/g,"\n"),idx>1&&document.getElementById("js_content")&&1446652800>ct&&(j=document.getElementById("js_content").innerHTML.replace(/<\/?[^>]*\/?>/g,"").htmlDecode().replace(/^(\s*)|(\s*)$/g,"").substr(0,54)),
b.isCDN()&&(b=b.replace(/\/0$/,"/300"),b=b.replace(/\/0\?/,"/300?")),k.isCDN()&&(k=k.replace(/\/0$/,"/640"),
k=k.replace(/\/0\?/,"/640?")),malicious_title_reason_id&&(f=o.maliciousTitleMap[malicious_content_type][malicious_title_reason_id]||f,
j=o.maliciousDescMap[malicious_content_type][malicious_title_reason_id]||j,1!=malicious_content_type&&(b="https://mmbiz.qlogo.cn/mmbiz_png/cVgP5bCElFiayFgbgEB9iaDt7hLicfz9RrXGM0LpaQ0TUic2gP7lbbqU3jCD8ibonicgIa3p99yjx1f1P26HChraeRUg/0?wx_fmt=png")),
"1"==is_limit_user&&g.call("hideOptionMenu"),window.is_temp_url&&g.invoke("hideMenuItems",{
...
var z="https://res.wx.qq.com/op_res/Fwh9olR917lxUMxpJVM5sCCyrQOJSm68IEt-HfL7vpc5-_etzmyuLg1kPdU6RNRX";
g.on("menu:share:appmessage",function(e){
if(window.is_wash){
var s=Date.now();
...
n(v,fakeid,a,s,e.shareScene);
});
}else{
var a=1,r=t(b,"1");
e&&"favorite"==e.scene&&(a=24,r=t(b,"4"),l&&l.render&&l.render("share")),1==malicious_content_type&&(r="https://mmbiz.qlogo.cn/mmbiz_png/cVgP5bCElFiayFgbgEB9iaDt7hLicfz9RrXGM0LpaQ0TUic2gP7lbbqU3jCD8ibonicgIa3p99yjx1f1P26HChraeRUg/0?wx_fmt=png");
var s=Date.now();
g.invoke("sendAppMessage",{
appid:w,
img_url:r,
...
n(v,fakeid,a,s,e.shareScene),l&&l.render&&l.render("share");
});
}
}),g.on("menu:share:timeline",function(e){
if(window.is_wash){
var s=Date.now();
...
n(v,fakeid,2,s,e.shareScene),l&&l.render&&l.render("share");
});
}
});
g.on("menu:share:weiboApp",function(){
var e=Date.now();
g.invoke("shareWeiboApp",{
img_url:b,
link:i(v,3,e),
title:f
},function(){
...
var e=Date.now();
n(v,fakeid,7,e),g.invoke("shareFB",{
img_url:k,
img_width:"640",
img_height:"640",
link:i(v,43,e),
...
}),g.on("menu:share:QZone",function(){
var e=t(b,"6"),s=Date.now();
n(v,fakeid,5,s),g.invoke("shareQZone",{
img_url:e,
img_width:"640",
img_height:"640",
link:i(v,22,s),
...
}),g.on("menu:share:qq",function(){
var e=t(b,"7"),s=Date.now();
n(v,fakeid,5,s),g.invoke("shareQQ",{
img_url:e,
img_width:"640",
img_height:"640",
link:i(v,23,s),
...
}),g.on("menu:share:email",function(){
var e=Date.now();
n(v,fakeid,5,e),g.invoke("sendEmail",{
content:i(v,5,e),
title:f
},function(){});
}),g.on("sys:record",function(){
g.invoke("recordHistory",{
link:v,
title:f,
source:nickname,
img_url:b
