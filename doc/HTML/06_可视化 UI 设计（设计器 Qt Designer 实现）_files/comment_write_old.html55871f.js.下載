...
var f=function(){
var e=function(e){
e.classList.remove(B),p&&(clearTimeout(p),p=null),y&&(y=!1);
};
return function(t){
var i=t.el;
...
}),n.showActionSheet(e,a,l),o.classList.remove(B),i.preventDefault(),y=!0;
},h=function(e){
var t=e.el;
p?(clearTimeout(p),p=null):t.classList.remove(B),d&&clearTimeout(d);
};
...
_defineProperty(n,z,null),_defineProperty(n,K,null),_defineProperty(n,W,null),_defineProperty(n,E,null),
