...
function i(o){
if(f.loadingMd5!==!0&&"function"==typeof o.callback){
var t=d({
vid:o.vid,
id:o.id,
id_type:o.id_type,
...
if(t.android_md5||"android"!=f.system)return void o.callback(t);
...
callbackName:a,
callback:function(a){
f.loadingMd5=!1,a&&a.md5&&(t.android_md5=a.md5,f.android_md5=a.md5),o.callback(t);
},
onerror:function(){
f.loadingMd5=!1;
}
...
android_open_url:f.android_open_url.replace("#defaultArg#",t).replace("#fromId#",o.fromId),
wp_open_url:"",
pc_open_url:"http://v.qq.com/page/"+o.vid+".html",
wp_download_url:"",
ios_download_url:"https://itunes.apple.com/cn/app/id458318329?mt=8",
android_md5:f.android_md5,
...
var r=window.withoutIframe?window:window.parent.window,l=o(window.withoutIframe?"appmsg/without_iframe/iframe_communicate.js":"pages/iframe_communicate.js"),p=o("pages/video_plugin/base.js"),_=o("pages/loadscript.js"),c=o("biz_wap/jsapi/core.js"),u=o("pages/video_plugin/sha1.js"),m=o("biz_common/dom/event.js"),w=o("pages/app_open.js"),f={
debug:r.location.href.indexOf("&vconsole=1")>=0?!0:!1,
android_md5:"",
...
return m.tap(a.main[0],function(){
t._trigger("openapp",{
vid:t._o.vid,
id:t._o.vid,
fromId:787
...
var o=arguments[1],t=this,a=this.player,e=this._g,n=o.id,d=o.id,s=o.id_type,l=o.alginfo,p=o.pc_open_url,_=e.appInfo[n];
return _?(_.open(),1):(i({
vid:n,
id:d,
id_type:s,
fromId:o.fromId,
callback:function(i){
i.alginfo=l||"",i.vid=n,i.id=d,i.pc_open_url=p||"",i.id_type=s,i.fromId=o.fromId,
...
instance:this
}),top!=window?r.location.href=o:window.location.href=o);
...
},e.appInfo[n]=new w.create(i),e.appInfo[n].open();
}
}),1);
...
action_url:f.android_open_url.replace("#defaultArg#",t).replace("#fromId#",o.fromId)
};
e=JSON.stringify(e),a.update(e+f.sha1_key);
...
!!f.debug&&r.console.log("data:"+i),this._writeCommDataJsapi({
data:i
});
...
!!f.debug&&r.console.log("writeCommData res:"+JSON.stringify(t)),/:ok$/.test(t.err_msg)?"function"==typeof o.onSuccess&&o.onSuccess():"function"==typeof o.onError&&o.onError();
});
},n.prototype._androidDownloadFail=function(o){
this._clearCommData(),this._stopDownloadBar(),o===!0&&setTimeout(function(){
e("腾讯视频户端下载失败，请检查检查网络状态或稍后再试");
},0);
...
a.androidDownloadId&&o?w.install(a.androidDownloadId):o&&e("腾讯视频户端下载完成，请检查下载任务并安装"),
...
t&&e("正在下载腾讯视频户端，请稍后"),this._startDownloadBar();
...
define("appmsg/without_iframe/video_plugin/video_tail.js",["biz_wap/jsapi/core.js","common/utils.js","biz_wap/utils/device.js","common/comm_report.js","pages/video_plugin/base.js","appmsg/without_iframe/video_plugin/video_tail_utils.js","pages/video_collection/report.js","appmsg/like_and_share.js"],function(e){
"use strict";
function a(e,a){
...
var t=e("biz_wap/jsapi/core.js"),r=e("common/utils.js"),l=e("biz_wap/utils/device.js"),n=e("common/comm_report.js"),s=e("pages/video_plugin/base.js"),o=e("appmsg/without_iframe/video_plugin/video_tail_utils.js"),d=e("pages/video_collection/report.js"),g=e("appmsg/like_and_share.js");
...
var t=_extends({},i);
if(l.os.android&&this.player._g.myPlayer&&this.player._g.myPlayer.opt.width<=this.player._g.myPlayer.opt.height)if(i.state){
var r=this.player._g.myPlayer.getWcSlPlayerAndroidSafeAreaInsets();
t.padding=r.top+"px 0 0 0";
}else t.padding="0";
...
var i=function r(){
e._g.tailIframe.removeEventListener("error",r),e._g.tailIframe.remove(),e._g.tailIframe=null,
...
if("triggerLikeBtn"===a.data)return void g.triggerLike(6);
...
"commReport"===i.dataType&&n.report(i.logId,i.logData);
...
var l=e.player._g.myPlayer;
if(l&&i.data.__wcSlPlayerLoadTailRelateVideo__)return l.exitFullScreen(),d.leaveReportNowForSwitchVideo(),
void r.loadNewPageKeepingHistoryStackIfSecOpen(i.data.__wcSlPlayerLoadTailRelateVideo__);
if(l&&i.data.__videoTailPlayerId__&&i.data.__videoTailPlayerId__===l.id){
var n=i.data.data;
...
var t=function l(){
e._g.tailIframe.removeEventListener("load",l),e.fullscreenchangeHandler("fullscreenchange",{
state:e.player.isInFullScreen()
});
};
...
return e._g.tailIframe.addEventListener("error",r),"break";
}();
if("break"===o)break;
}
