...
function n(e){
d||"function"!=typeof e||window.top.__fontScaleChangeCbList__.push(e);
}
function i(){
...
t(e,1/i),!d&&(window.top.__fontScaleBackForAndroid__=1/i),p.set("__font_scale_back_for_android__",1/i);
}),i;
}
return null;
}
var s=e("biz_wap/utils/mmversion.js"),r=e("biz_wap/jsapi/core.js"),l=e("biz_wap/utils/device.js"),p=e("biz_wap/utils/localstorage.js"),d=!1;
try{
d=!window.top.document;
}catch(_){
d=!0;
}
var c=l.os.ipad&&l.os.getNumVersion()>=13&&l.os.getNumVersion()<14;
return d||window.top.__fontScaleChangeCbList__||(window.top.__fontScaleChangeCbList__=[]),
window.top===window&&r.on("menu:setfont",function(e){
if(s.isIOS&&location.href.match(/fontScale=\d+/))parseFloat(e.fontScale)<=0&&(e.fontScale=100),
c?(t(document.getElementsByTagName("html").item(0),e.fontScale/100),window.ipados13_font_scale=e.fontScale):document.getElementsByTagName("html").item(0).style.webkitTextSizeAdjust=e.fontScale+"%";else if(s.isAndroid)r.invoke("setFontSizeCallback",{
fontSize:e.fontSize
});else if(s.isWindows){
var o,n=e.fontGear||2,i=["appmsg_desktop_fontsize_1","appmsg_desktop_fontsize_2","appmsg_desktop_fontsize_3","appmsg_desktop_fontsize_4","appmsg_desktop_fontsize_5","appmsg_desktop_fontsize_6"];
...
var t="https://res.wx.qq.com/open/libs/weui/2.4.4/weui.min.css",r="https://res.wx.qq.com/t/wx_fed/cdn_libs/res/weui/1.2.3/weui.min.js",a=[];
if(!e()){
