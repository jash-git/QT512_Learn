...
var tpl='<div class="comment__push__container"><div class="js_bottom_input_mask comment__push__mask" style="display: none;"></div><div class="js_bottom_input_wrapper comment__push" style="opacity: 0;"><div class="comment__push__inner"><div class="comment__push__wrp"><div class="js_bottom_input_faker comment__push__input__faker"></div><textarea class="js_bottom_input comment__push__input"></textarea></div></div><div class="comment__push__extend"><a href="javascript:;" class="js_bottom_input_emoji comment__push__emoji"></a><a href="javascript:;" class="js_bottom_input_submit comment__push__send">发送</a></div></div></div>';
...
this.state.keyboardHeight&&this.$el.find(".js_bottom_input_emoji_panel").css({
...
var i=0;
Device.os.getNumVersion()<13&&(i=this.state.keyboardHeight?(window.innerHeight+this.state.keyboardHeight-this.$inputWrapper.offset().height)/2:window.innerHeight-this.$inputWrapper.offset().height),
this.$inputWrapper.css({
opacity:0,
bottom:i,
...
var n=this.inputEle.value.length;
this.inputEle.setSelectionRange(n,n),t&&(this.showEmotionFirst=!0,this.__triggerEmojiPanel());
}
...
this.state.show=!1,this.inputEle.blur(),this.__emit("hide",t));
