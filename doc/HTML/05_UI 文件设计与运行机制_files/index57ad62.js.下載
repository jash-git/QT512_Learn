...
function q(){
tt&&clearTimeout(tt),tt=setTimeout(function(){
try{
tt=null;
for(var e=0;e<U.length;e++){
var t=U[e],i=_.attr(t,"data-showed");
if("no"==i){
...
function N(e){
try{
for(var d=window.pageYOffset||document.documentElement.scrollTop,c=0;c<U.length;c+=Q){
var m=U[c];
if(!(m.offsetTop>d+E.getInnerHeight()+100)){
var w=_.attr(m,"data-cpsstatus");
if("hide"==w){
m.setAttribute("data-cpsstatus","loading");
for(var u=""+c,g=1,h=c+1;h<U.length&&c+Q>h;h++)u=u+"%2c"+h,g++;
var v=Math.ceil(1e7*Math.random());
if(""!==t("mockcps"))var b="/mp/cps_product_info?biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&cpslist="+u+"&sn="+window.sn+"&mockcps="+t("mockcps");else var b="/mp/cps_product_info?biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&cpslist="+u+"&sn="+window.sn+"&istempurl="+(window.is_temp_url||0)+"&random="+v;
!function(e,t,d){
l({
url:t,
type:"GET",
...
var c=U[e.product_list[t].index],m=e.product_list[t].template_id;
...
try{
!function(){
var i=e.delegatedTarget,n=i.getAttribute("data-wxaappid"),r=i.getAttribute("data-wxapath"),a=i.getAttribute("data-pid"),s=i.getAttribute("data-appid"),d=i.getAttribute("data-cpspackage"),c=Math.floor((new Date).getTime()/1e3)+5184e3,m=i.getAttribute("data-weapp_username"),w=i.getAttribute("data-weapp_version");
p.jumpUrl({
...
function M(e){
try{
et&&clearTimeout(et),et=setTimeout(function(){
N(e);
},300);
}catch(e){}
}
...
}),""==document.getElementById("js_content").innerHTML.trim()&&C.setSum(24729,94,1);
var t=Math.random();
.001>t&&document.getElementById("js_read_area3")&&document.getElementById("js_read_area3").innerText&&document.getElementById("js_read_area3").innerText.indexOf("Pageview")>-1&&C.setSum(24729,95,1),
window.__wxjs_is_wkwebview&&C.setSum(28307,67,1);
}
try{
var U=document.getElementsByTagName("mpcps");
window.__addIdKeyReport("64469","15",U.length);
for(var V=0;V<U.length;V++){
U[V].setAttribute("data-cpsstatus","hide"),U[V].setAttribute("data-showed","no");
var X={
cps_isready:!1,
cps_state:"",
pid_type:"",
...
source_logo_url:"",
is_ad:1
},$=_.attr(U[V],"data-templateid");
"list"==$?U[V].innerHTML=n.tmpl(s,X,!1):"banner"==$?U[V].innerHTML=n.tmpl(r,X,!1):"card"==$&&(U[V].innerHTML=n.tmpl(a,X,!1));
}
}catch(Z){
console.log(Z);
}
...
try{
J.init(document.getElementById("js_tags"));
}catch(Z){
console.log(Z);
}
var et=void 0,tt=null;
q(),y.on(window,"scroll",q),N(),y.on(window,"scroll",M),window.is_new_msg&&-1!=navigator.userAgent.indexOf("MicroMessenger")&&(window.title&&(window.title=window.title.replace(/&#39;/g,"'").replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&quot;/g,'"').replace(/&amp;/g,"&")),
...
o.width<2048&&o.height<2048&&(e.cover=t,T.init(e)),window.topbarInited=!0;
},o.onerror=function(){
...
L||(!f.isAndroid||window.topbarInited)&&(D(0),L=!0);
}),v.invoke("createWebViewForFastLoad",{
scene:1
},function(e){
console.log(e);
}));
var ot=document.getElementsByTagName("body");
if(!ot||!ot[0])return!1;
ot=ot[0],function(){
function e(){
...
}),"1"===window.localStorage.getItem(t)&&z.report110809(30)),e)for(var d=document.getElementsByClassName("js_pay_qrcode"),p="/mp/paysubqrcode?action=get_article_qrcode&__biz="+window.biz+"&mid="+window.mid+"&idx="+window.idx+"&sn="+window.sn+"#wechat_redirect",c=0,w=d.length;w>c;c++)d[c].src=p;
...
e=null,console.log("getIAPProductInfo timeout"),z.reportOverseaPay("",0,1,0,"",2,"");
},3e3),t=Date.now();
...
var a=function(){
if(z.report110809(38),window.payProductId!==i.productId)return z.report110809(44),
{
v:void 0
};
var e={
...
}),window.oriProductFee?("CNY"!==i.currencyCode&&z.report110809(40),z.reportOverseaPay(i.currencyCode,100*i.price.toFixed(2),1,r,i.countryCode,0,i.err_msg+(i.err_desc?"__"+i.err_desc:""))):(window.IAPProductInfo=i,
window.IAPProductInfo.invokeTime=r);
}();
if("object"===("undefined"==typeof a?"undefined":_typeof(a)))return a.v;
}else z.report110809(39),z.reportOverseaPay("",0,1,0,"",1,i.err_msg+(i.err_desc?"__"+i.err_desc:""));
}
});
...
_(),y.on(window,"scroll",_);
var u=!1,g=0,h=function b(o,i){
if(z.report110809ForDevice(32),!f.isInMiniProgram){
...
if(!e&&1*n.dataset.ready===0)return!i&&B.show("生成订单中"),new Date-g>6e4?(B.hide(),
window.weui.alert("支付超时，请稍后重试"),void(u=!1)):setTimeout(b,100,{
currentTarget:n
},!0);
if(z.reportPayAppmsg(9),1===window.is_transfer_msg)return window.weui.confirm("此内容来自于迁移前的帐号，不支持付费",{
buttons:[{
type:"default",
label:"确定"
}]
}),void(u=!1);
if(window.is_teenager)return window.weui.alert("青少年模式下不可付费"),C.setSum(232209,0,1),
void(u=!1);
...
f.isAndroid&&"1"===window.localStorage.getItem(t)&&z.report110809(31),z.report110809ForDevice(34);
var e=function(){
z.reportPayAppmsg(1),P.renderLikeProfile(["pay"]),O&&O.render&&O.render("pay"),v.invoke("handleMPPageAction",{
action:"paySuccess",
fullUrl:window.location.href,
itemShowType:item_show_type
},function(e){
u=!1,z.report110809(e.err_msg.indexOf("ok")>-1?19:20),window.localStorage&&window.localStorage.setItem&&window.localStorage.setItem(t,"1"),
...
z.report110809(13),z.report110809ForDevice(36);
...
z.reportPay(o,1,t.order_id),e()):i.err_msg.indexOf("cancel")>-1?(u=!1,z.report110809(28),
z.reportPay(o,2,t.order_id),console.log("pay cancel")):i.err_msg.indexOf("fail")>-1?(u=!1,
z.report110809(16),z.reportPay(o,3,t.order_id,i.err_msg,i.err_code,i.err_domain),
...
var e=setTimeout(function(){
e=null,console.log("getIAPProductInfo timeout"),z.reportOverseaPay("",0,2,0,"",2,"");
},3e3),t=Date.now();
v.invoke("handleMPPageAction",{
action:"getIAPProductInfo",
productId:window.payProductId
...
if(z.report110809(41),window.payProductId!==o.productId)return void z.report110809(44);
window.IAPProductInfo?window.IAPProductInfo.currencyCode!==o.currencyCode&&z.report110809(43):window.oriProductFee&&"CNY"!==o.currencyCode&&z.report110809(43),
z.reportOverseaPay(o.currencyCode,100*o.price.toFixed(2),2,i,o.countryCode,0,o.err_msg+(o.err_desc?"__"+o.err_desc:""));
}else z.report110809(42),z.reportOverseaPay("",0,2,0,"",1,o.err_msg+(o.err_desc?"__"+o.err_desc:""));
}
});
}();
}else{
...
console.log("directPay res: ",i,n),1===i?(z.report110809(17),z.reportPay(o,1,t.order_id,n,i),
e()):-1===i&&/:cancel$/.test(n)?(u=!1,z.report110809(29),z.reportPay(o,2,t.order_id,n,i),
console.log("pay cancel")):(u=!1,z.report110809(18),z.reportPay(o,3,t.order_id,n,i),
...
case 202617:
window.weui.alert("青少年模式下不可付费"),C.setSum(232209,0,1);
break;

default:
z.report110809(14),window.weui.alert("订单创建失败，请稍后重试");
}
},
error:function(){
...
var nt=/^http(s)?:\/\/mp\.weixin\.qq\.com\//g;
try{
if(top!=window&&(!top||top&&location.href&&nt.test(location.href))&&!window.isSg)throw new Error("in iframe");
}catch(Z){
var rt="",at=new Image;
at.src=("http://mp.weixin.qq.com/mp/jsreport?key=4&content=biz:"+biz+",mid:"+mid+",uin:"+uin+"[key4]"+rt+"&r="+Math.random()).substr(0,1024);
}
if(window.isInWeixinApp()&&/#rd$/.test(location.href)&&!window.isWeixinCached&&!window.__second_open__&&!f.is_wxwork){
var st=-1!=location.href.indexOf("?")?"&":"?";
location.replace(location.href.replace(/#rd$/,st+"rd2werd=1#wechat_redirect"));
}
var dt=e("biz_common/utils/url/parse.js");
e("appmsg/cdn_img_lib.js"),window.page_endtime=+new Date;
{
var pt=!f.isWp&&-1==navigator.userAgent.indexOf("MicroMessenger");
-1!=navigator.userAgent.indexOf("WindowsWechat");
}
e("appmsg/share.js");
var ct=pt?null:new d({
is_https_res:is_https_res
}),mt=b(1e3*parseInt(window.modify_time)),wt=mt.format("YYYY/MM/DD"),lt=document.getElementById("js_modify_time");
if(lt&&(lt.innerHTML=wt),window.isSg||"mp.weixin.qq.com"==location.host){
var _t=e("biz_common/log/jserr.js");
_t({
key:0,
...
var ut=-1!=navigator.userAgent.indexOf("TBS/"),gt=function(e,t){
W(e,function(e,o){
...
ut&&1>=n&&(i.lossy=i.lossless=i.alpha=1,window.logs.webplog=i);
...
(F||navigator.userAgent.indexOf("Br_trunk")>-1)&&f.isIOS&&(s||d)&&!p?(console.info("[HEVC代理] 当前版本可以启用HEVC代理"),
v.invoke("imageProxyInit",{},function(t){
t.err_msg.indexOf(":ok")>-1?(G=t.serverUrl,window.__addIdKeyReport("28307",117)):t.err_msg.indexOf(":fail")>-1&&window.__addIdKeyReport("28307",118),
e();
})):e();
},ht=function(e){
gt("lossy",e),gt("lossless",e),gt("alpha",e),gt("animation",e);
};
if(window.webp=!1,ft(function(){
ht(function(t){
function o(e){
...
t.src=dt.addParam(e,"retryload",t.__retryload,!0),!1;
}))));
}
function r(e){
...
e&&(e.isCDN()&&(e=e.imgChange640(),t&&(e=dt.addParam(e,"tp","webp",!0)),e=dt.addParam(e,"wxfrom","5",!0),
is_https_res||H?e=e.http2https():("http:"==location.protocol||-1!=navigator.userAgent.indexOf("MicroMessenger"))&&(e=e.https2http())),
setTimeout(function(){
a.onload=function(){
...
var I=A.item(j),E=I.getAttribute("href")||"";
null!=E.match(/^http/)&&b(I);
}
}catch(k){}
var z=!1;
...
l&&(_||g)?(o=dt.addParam(o,"tp","wxpic",!0),window.__addIdKeyReport("28307",91)):window.webp&&(o=dt.addParam(o,"tp","webp",!0),
window.__addIdKeyReport("28307",84)),o=dt.addParam(o,"wxfrom","5",!0),is_https_res||H?(o=o.http2https(),
...
o=o.replace(y,"http://m.qpic.cn"),/^http(s)?:\/\/m\.qpic\.cn([\/?].*)*$/i.test(o)&&!window.webp&&(o=dt.addParam(o,"t","",!0)),
o=dt.addParam(o,"wx_lazy","1",!0);
var v=f.gtVersion("6.5.13",!0)&&!f.eqVersion("7.0.9")&&o.isGif(),b=f.gtVersion("6.8.0",!0)&&o.canHevc()&&!(f.eqVersion("7.0.9")&&o.isGif());
return G&&(v||b)&&(window.__addIdKeyReport("28307",106),o=dt.addParam(o,"tp","wxpic",!0),
o=G+"hevc?url="+encodeURIComponent(o)+"&type="+o.getOriginImgType()),"anonymous"==e.crossOrigin&&(o=dt.addParam(o,"wx_co","1",!0)),
...
mid:"mmbizwap:imgMonitor",
view:"wap_appmsg"
}),G&&e.indexOf(G)>-1&&window.__addIdKeyReport("28307",108),d>i){
...
e.indexOf(!1)&&(e=e.http2https())),G&&e.indexOf(G)>-1){
var a=e.split("hevc?url=")[1];
a=a.split("&type")[0],a=decodeURIComponent(a),a=a.replace("tp=wxpic",""),e=a.https2http();
}
t.start_load_time=+new Date,t.src=dt.addParam(e,"retryload",i,!0);
}
...
r(t),ct&&ct.bindEvent(t),t.gray&&!t.loadGif&&((t.width||t.naturalWidth)<120||(t.height||t.naturalHeight)<120?t.autoTap&&t.autoTap():t.span&&t.span.children&&t.span.children.item(0)&&(t.span.children.item(0).style.display=""));
...
1>=n&&window.__addIdKeyReport("28307",87+1*n)),G&&e.indexOf(G)>-1&&window.__addIdKeyReport("28307",107),
...
var yt=document.getElementById("js_cover");
ct.add({
...
var vt=e("appmsg/copyright_report.js");
!function(){
...
e("appmsg/qqmusic.js");
var jt=e("appmsg/voice.js"),It=[];
if(voiceList&&voiceList.voice_in_appmsg&&voiceList.voice_in_appmsg.length>0&&(It=voiceList.voice_in_appmsg),
jt.init(It),e("redpackage/redpacketcover.js"),e("appmsg/search/search.js"),e("appmsg/poi/poi.js"),
...
var xt=e("question_answer/appmsg.js");
xt.renderQaCard&&xt.renderQaCard({
mid:window.mid,
idx:window.idx,
...
var kt=e("appmsg/appmsg_copy_report.js");
new kt({
biz:window.biz,
...
}),g(),h(),y.tap(document.getElementById("js_hotspot_area"),function(e){
...
if(pt)!function(){
document.title=window.msg_title.htmlDecode(),m.addClass(ot,"not_in_mm");
...
if(vt.card_pv_report(),Math.random()<.01)try{
...
1!==i()||o||(z.report110809(63),window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs&&window.WX_BJ_REPORT.BadJs.report("horizontal screen report","biz: "+("function"==typeof window.atob?window.atob(window.biz):window.biz)+" | mid: "+window.mid+" | idx: "+window.idx+" | url: "+location.href,{
...
scroll:window.pageYOffset||document.documentElement.scrollTop,
istouchmove:!1
}),1!==r||o||(z.report110809(63),window.WX_BJ_REPORT&&window.WX_BJ_REPORT.BadJs&&window.WX_BJ_REPORT.BadJs.report("horizontal screen report","biz: "+("function"==typeof window.atob?window.atob(window.biz):window.biz)+" | mid: "+window.mid+" | idx: "+window.idx+" | url: "+location.href,{
mid:"mmbizwap:horizontal_screen",
view:"wap_business"
}),o=!0);
});
...
if(e[t].ori==i()&&(e[t].scroll=o,e[t].istouchmove=!0,!a)){
var s=E.getInnerHeight()+o;
r.offsetTop<s&&(a=!0,C.setSum(59977,15,1));
}
});
}
...
C.setSum(28307,18,1),f.isIOS&&C.setSum(28307,19,1),f.isAndroid&&C.setSum(28307,20,1);
},!1);
}(),function(){
...
var zt=Math.random();
if(2e-4>zt)try{
for(var Bt=document.getElementsByTagName("img"),Pt=window.screen.height,Rt=window.screen.width,St=0,Tt=window.devicePixelRatio,St="",V=0,Ct=Bt.length;Ct>V;V++){
var Ot=Bt[V].getAttribute("data-src");
if(Ot){
var qt=Bt[V].getBoundingClientRect();
St+=Rt+"|"+Pt+"|"+qt.left.toFixed(2)+"|"+(Rt-qt.right).toFixed(2)+"|"+qt.width.toFixed(2)+"|"+Tt.toFixed(2)+"|"+Ot+";";
}
}
l({
...
e("appmsg/popup_report.js")),z=e("appmsg/pay_report_utils.js"),B=e("appmsg/loading.js"),P=e("appmsg/like_profile.js"),R=-1,S=e("appmsg/finance_communicate.js"),T=e("appmsg/topbar.js"),C=e("biz_wap/utils/jsmonitor_report.js"),O=e("appmsg/related_article.js"),q=e("appmsg/getForbidConfig.js"),N=e("appmsg/set_article_read.js"),D=N.setArticleRead,L=!1;
e("appmsg/wxwork_hidden.js");
var M=e("common/color/background_color.js"),W=e("common/color/light.js"),K=e("common/color/dark.js"),J=e("appmsg/tags_utils.js");
M.set({
bottom:[W["BG-0"],K["BG-0"]]
}),window.new_appmsg&&(e("page/appmsg_new/combo.css"),e("page/appmsg_new/not_in_mm.css")),
e("appmsg/finance_communicate.js");
var U=window.user_uin||0,V=Math.floor(U/100)%1e3,H=0!==U&&1001>V,F=!0,G="",Q=5;
...
var X=window.performance||window.msPerformance||window.webkitPerformance;
if(!X||!X.timing)return;
