...
"use strict";
function e(){
console.log(h),l.isWindows?location.href=h:r.invoke("profile",{
username:f,
scene:"209"
},function(){});
}
...
var c=s.friend_subscribe_count,b=s.is_subscribed,k=s.orignal_num,z=s.is_ban;
if(!(b||z||m("js_focus"))){
...
}),l.isWindows?location.href=h:r.invoke("quicklyAddBrandContact",{
username:f,
scene:y
},function(o){
...
function r(){
var t,e=/MicroMessenger\/[\d\.]+\(0x(.+?)\)/i,i=d.match(e);
return i&&i[1]&&null!=i[1]?i[1]:!i&&/MicroMessenger\/[\d\.]+/i.test(d)&&(t=n(),t.version)?t.version:!1;
}
function s(n,i,r,s){
var o=!1;
switch(s){
...
for(var c,a,u=P["cp"+i],d=0,p=Math.max(o.length,n.length);p>d;++d){
c=o[d]||0,a=n[d]||0,c=parseInt(c)||0,a=parseInt(a)||0;
var f=P.cp0(c,a);
if(!f)return u(c,a);
}
return r||0==i?!0:!1;
...
var d=navigator.userAgent,p=/(iPhone|iPad|iPod|iOS)/i.test(d),f=/Windows\sPhone/i.test(d),g=/(Android)/i.test(d),m=/MicroMessenger\/([\d\.]+)/i.test(d),w=/mac\sos/i.test(d),h=/windows\snt/i.test(d)&&!f,l=/MPAPP\/([\d\.]+)/i.test(d),v=g&&/miniprogram/.test(d.toLowerCase())||"miniprogram"==window.__wxjs_environment,M=m&&/wxwork/i.test(d),P={
"cp-1":function(n,t){
return t>n;
},
cp0:function(n,t){
